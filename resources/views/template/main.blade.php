...
<head>
    ...
    <title>e-Learning 69 | {{ $title }}</title>
...
<body class="sidebar-noneoverflow">
            ...
            @if (!Request::is('siswa/ujian/*'))
                <ul class="navbar-nav theme-brand flex-row text-center">
                    <li class="nav-item theme-logo">
                        <a href="">
                            <img src="{{ url('/assets/img') }}/smkn69.png" class="navbar-logo" alt="logo">
                        </a>
                    </li>
                    <li class="nav-item theme-text">
                        <a href="" class="nav-link"> E-69 </a>
                    </li>
            ...
            <ul class="navbar-item flex-row navbar-dropdown">
                ...
                <li class="nav-item dropdown user-profile-dropdown  order-lg-0 order-1">
                    ...
                    <div class="dropdown-menu position-absolute animated fadeInUp"
                        ...
                        @if (Str::startsWith($currentPath, 'siswa/ujian'))
                            <div class="dropdown-item">
                                <a href="{{ url('/siswa') }}">
                                    <span data-feather="home"></span> <span>Kembali</span>
                                </a>
                            </div>
                        @endif
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // --- IMPORTANT: Adjust this selector if your sidebar has a different class or ID ---
            const sidebar = document.querySelector('.sidebar-wrapper'); // Example selector

            // Regex to match '/siswa/ujian/' followed by any characters until the end of the string
            const ujianKodeRegex = /^\/siswa\/ujian\/.*$/;

            // Extract the path part of the URL
            const urlPath = new URL(currentUrl).pathname;

            if (ujianKodeRegex.test(urlPath)) {
                // Hide the sidebar
                if (sidebar) {
