...
<head>
    ...
    <title>Akun e-Learning 69</title>
</head>
<body>
    <div style="padding: 10px;">
        ...
        <small style="color: #000;">CBT69</small>
        <p style="font-family: `Segoe UI`, Tahoma, Geneva, Verdana, sans-serif; color: #000;">
            Halo {{ $details['nama'] }}, Admin telah menambahkan kamu kedalam aplikasi e-Learning 69, berikut merupakan informasi akunmu :
        </p>
