...
Route::post('/request-password-change', [AuthController::class, 'requestPasswordChange'])->name('request.password.change');
...
Route::post('/admin/smtp_email/{id}', [AdminController::class, 'smtp_email'])->middleware('is_admin');
 // Rute Permintaan Password
    Route::get('/admin/password-requests', [AdminController::class, 'listPasswordRequests'])->middleware('is_admin');;
    
    // Proses setuju (Ubah password & hapus request)
    Route::post('/admin/password-requests/{passwordRequest}/agree', [AdminController::class, 'agreePasswordRequest'])->middleware('is_admin');;
    
    // Proses tidak setuju (Hapus request tanpa ubah password)
    Route::post('/admin/password-requests/{passwordRequest}/disagree', [AdminController::class, 'disagreePasswordRequest'])->middleware('is_admin');;
// =============SISWA
// ==>View
...
// BARU :: Rute untuk duplikat ujian
Route::post('/guru/ujian/duplikat', [UjianGuruController::class, 'duplikat'])->middleware('is_guru');
...
// Tambahkan route ini untuk melaporkan pelanggaran
Route::post('/siswa/ujian/laporkan-pelanggaran', [UjianSiswaController::class, 'laporkan_pelanggaran'])->name('siswa.ujian.laporkan_pelanggaran')->middleware('is_siswa');
